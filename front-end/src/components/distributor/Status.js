...
export default function Status({
  ...
  const confirmed =
    (orders.length / products.length / retailerCount.total) * 100;
    ...
    <>
      ...
      <div className="chart-box">
        ...
        >
          ...
          >
            <div>
              <h2 className="m-0 order-items-number blue">
                {orders.length / products.length}
              </h2>
              <h6 className="order-items-text mb-1">retailers confirmed</h6>
              <h2 className="m-0 order-items-number dark-blue">
                {retailerCount.ordered}
              </h2>
